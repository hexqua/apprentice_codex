...
public final class RecipeRegistry {
    ...
    public static final RegistryObject<RecipeSerializer<AlchemyBrewerRecipe>> ALCHEMY_BREWER_SERIALIZER =
            RECIPE_SERIALIZERS.register("alchemy_brewer", AlchemyBrewerRecipeSerializer::new);
    public static final RegistryObject<RecipeSerializer<AlchemyBrewerModifierRecipe>> ALCHEMY_BREWER_MODIFIER_SERIALIZER =
    ...
    public static final RegistryObject<RecipeSerializer<AlchemistsFlaskSmithingRecipe>> ALCHEMISTS_FLASK_SMITHING_SERIALIZER =
    ...
    public static final RegistryObject<RecipeSerializer<AlchemistsFlaskTippedArrowRecipe>> ALCHEMISTS_FLASK_TIPPED_ARROW_SERIALIZER =
            RECIPE_SERIALIZERS.register(
    ...
    public static final RegistryObject<RecipeType<AlchemyBrewerRecipe>> ALCHEMY_BREWER_RECIPE_TYPE =
    ...
    public static final RegistryObject<RecipeType<AlchemyBrewerModifierRecipe>> ALCHEMY_BREWER_MODIFIER_RECIPE_TYPE =
