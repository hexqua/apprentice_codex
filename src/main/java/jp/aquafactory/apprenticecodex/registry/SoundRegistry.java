...
public final class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_RECONSTRUCT = reg("vanilla_floatmount_broom_reconstruct");
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_DAMAGE = reg("vanilla_floatmount_broom_damage");
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_CRITICAL_DAMAGE = reg("vanilla_floatmount_broom_critical_damage");
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_WARNING = reg("vanilla_floatmount_broom_warning");
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_EMERGENCY = reg("vanilla_floatmount_broom_emergency");
    public static final RegistryObject<SoundEvent> VANILLA_FLOATMOUNT_BROOM_MOUNT_REJECT = reg("vanilla_floatmount_broom_mount_reject");
