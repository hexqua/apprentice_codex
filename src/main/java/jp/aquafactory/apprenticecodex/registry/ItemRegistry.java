...
public final class ItemRegistry {
    ...
    public static final RegistryObject<Item> SHOOTING_STAR_MANTLE =
    ...
    public static final RegistryObject<Item> MANA_MANEUVER_GEAR =
    ...
    public static final RegistryObject<Item> UNDYING_EMBLEM =
            ITEMS.register("undying_emblem", UndyingEmblem::new);
    public static final RegistryObject<Item> MANA_SOUL_TRANSDUCER =
            ITEMS.register("mana_soul_transducer", ManaSoulTransducer::new);
    ...
    public static final RegistryObject<Item> INSTANT_SEARCH_BRAZIER =
    ...
    public static final RegistryObject<Item> ANTI_MANA_ARROW =
