...
public final class SpellRegistry {
    ...
    public static final RegistryObject<AbstractSpell> BLOODY_ARROW = reg("bloody_arrow", BloodyArrow::new);
    ...
    public static final RegistryObject<AbstractSpell> CATCH_FLAME = reg("catch_flame", CatchFlame::new);
    public static final RegistryObject<AbstractSpell> THERMAL_SLICE = reg("thermal_slice", ThermalSlice::new);
    ...
    public static final RegistryObject<AbstractSpell> IDOL_RECONSTRUCTION = reg("idol_reconstruction", IdolReconstruction::new);
    public static final RegistryObject<AbstractSpell> SACRED_ARROW = reg("sacred_arrow", SacredArrow::new);
    ...
    public static final RegistryObject<AbstractSpell> LUNAR_AIM = reg("lunar_aim", LunarAim::new);
    ...
    public static final RegistryObject<AbstractSpell> LIGHTNING_ARROW = reg("lightning_arrow", LightningArrow::new);
    ...
    public static final RegistryObject<AbstractSpell> ECHO_ARROW = reg("echo_arrow", EchoArrow::new);
}
