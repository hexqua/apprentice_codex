...
public final class SpellRegistry {
    ...
    public static final DeferredHolder<AbstractSpell, AbstractSpell> HEAVENLY_FIST = reg("heavenly_fist", HeavenlyFist::new);
    public static final DeferredHolder<AbstractSpell, AbstractSpell> TERRA_RESONANCE = reg("terra_resonance", TerraResonance::new);
