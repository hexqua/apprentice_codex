...
public final class EffectRegistry {
    ...
    public static final DeferredHolder<MobEffect, MobEffect> MANTLE_BURNING_DASH =
            EFFECTS.register("mantle_burning_dash", MantleBurningDashEffect::new);
    public static final DeferredHolder<MobEffect, MobEffect> MANTLE_VOLT_STRIKE =
    ...
    public static final DeferredHolder<MobEffect, MobEffect> INERT_MANA_SHIELD =
