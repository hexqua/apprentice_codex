...
public final class ElementalBowCalibrationGameTests {
    ...
    public static void elementalBowBenchKeepsInactiveScrollsExtractable(GameTestHelper helper) {
        ...
        helper.assertTrue(restrictions.size() == 1
                        && restrictions.getFirst().getContents() instanceof TranslatableContents text
        ...
        helper.assertTrue(ItemStack.isSameItemSameComponents(beforeTooltip, bow), "Tooltip reads must preserve bow components");
