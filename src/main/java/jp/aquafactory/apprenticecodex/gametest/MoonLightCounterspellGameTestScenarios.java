...
final class MoonLightCounterspellGameTestScenarios {
    ...
    static void successfulDamageAppliesCounterspellEffects(GameTestHelper helper) {
        helper.succeedIf(() -> {
            ...
            milkProofNormalEffect.getCures().clear();
            target.addEffect(milkProofNormalEffect);

            var milkProofMagicEffect = new MobEffectInstance(EffectRegistry.ECHO_SPELL, 200);
            milkProofMagicEffect.getCures().clear();
            ...
            helper.assertFalse(target.hasEffect(EffectRegistry.ECHO_SPELL),
