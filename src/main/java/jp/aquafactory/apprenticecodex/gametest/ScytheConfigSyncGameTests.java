        ...
        try {
            ...
            for (int offset : new int[]{0, 100}) {
                var values = new SpellReaperScytheServerConfig.Values(
                        311 + offset, 17, 23, 127 + offset, 7, 163 + offset, 19);
                var packet = new SyncSpellReaperScytheConfigPacket(values);
                SyncSpellReaperScytheConfigPacket.encode(packet, buffer);
                var decoded = SyncSpellReaperScytheConfigPacket.decode(buffer);
