...
final class SpellcasterQuiverGameTestScenarios {
    private static final UUID EXPANDED_BELT_MODIFIER_ID =
            UUID.fromString("6d7cb2e5-4c51-4d42-9a33-2bccd4402427");
    ...
    static void spellcasterQuiverAllowsOnlyOneEquippedAcrossSlots(GameTestHelper helper) {
        helper.succeedIf(() -> {
            ...
            curiosInventory.addTransientSlotModifier(
                    ...
                    EXPANDED_BELT_MODIFIER_ID,
                    "apprenticecodex:gametest/spellcaster_quiver_expanded_belt",
                    1.0D,
