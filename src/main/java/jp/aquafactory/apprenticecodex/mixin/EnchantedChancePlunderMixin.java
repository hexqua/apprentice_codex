...
public abstract class EnchantedChancePlunderMixin {
    @Shadow @Final
    ...
    private Object apprenticecodex$resolvePlunderAttacker(Object original, LootContext context) {
    ...
    private int apprenticecodex$applyPlunderLevel(int original, LootContext context) {
