...
public final class MistFormServerConfig {
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> passableBlockDenylist;
    ...
    private MistFormServerConfig(ForgeConfigSpec.ConfigValue<List<? extends String>> passableBlockDenylist) {
        this.passableBlockDenylist = passableBlockDenylist;
    }

    public static MistFormServerConfig define(ForgeConfigSpec.Builder builder) {
