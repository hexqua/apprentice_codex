...
public final class RiftHoleServerConfig {
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> dimensionDenylist;
    private final ForgeConfigSpec.BooleanValue enableDimensionAllowlist;
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> dimensionAllowlist;
    ...
    private RiftHoleServerConfig(
            ForgeConfigSpec.ConfigValue<List<? extends String>> dimensionDenylist,
            ForgeConfigSpec.BooleanValue enableDimensionAllowlist,
            ForgeConfigSpec.ConfigValue<List<? extends String>> dimensionAllowlist
    ) {
    ...
    public static RiftHoleServerConfig define(ForgeConfigSpec.Builder builder) {
        builder.push("RiftHole");
