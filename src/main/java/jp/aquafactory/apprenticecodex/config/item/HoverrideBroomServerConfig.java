...
public final class HoverrideBroomServerConfig {
    ...
    private final ForgeConfigSpec.DoubleValue rushMinimumDamage;
    private final ForgeConfigSpec.DoubleValue rushMaximumDamage;
    private final ForgeConfigSpec.DoubleValue rushManaCostPerTick;
    ...
    private HoverrideBroomServerConfig(
            ...
            ForgeConfigSpec.DoubleValue rushMinimumDamage,
            ForgeConfigSpec.DoubleValue rushMaximumDamage,
            ForgeConfigSpec.DoubleValue rushManaCostPerTick
    ) {
