...
public final class ArchivistsGrimoireServerConfig {
    ...
    private final ModConfigSpec.IntValue initialRows;
    private final ModConfigSpec.IntValue maxRows;

    private Values override;
    private boolean warnedInvalidRowBounds;

    private ArchivistsGrimoireServerConfig(ModConfigSpec.IntValue initialRows, ModConfigSpec.IntValue maxRows) {
        this.initialRows = initialRows;
        this.maxRows = maxRows;
    }

    public static ArchivistsGrimoireServerConfig define(ModConfigSpec.Builder builder) {
