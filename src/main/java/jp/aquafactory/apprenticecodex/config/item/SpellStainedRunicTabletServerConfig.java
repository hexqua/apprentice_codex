...
public final class SpellStainedRunicTabletServerConfig {
    ...
    private final ForgeConfigSpec.DoubleValue cooldownReductionFlat;
    private final ForgeConfigSpec.IntValue castTimeReductionMinimumDuplicateCount;
    private final ForgeConfigSpec.DoubleValue castTimeReductionPerDuplicate;
    private final ForgeConfigSpec.DoubleValue castTimeReductionFlat;
    ...
    private SpellStainedRunicTabletServerConfig(
            ...
            ForgeConfigSpec.DoubleValue cooldownReductionFlat,
            ForgeConfigSpec.IntValue castTimeReductionMinimumDuplicateCount,
            ForgeConfigSpec.DoubleValue castTimeReductionPerDuplicate,
            ForgeConfigSpec.DoubleValue castTimeReductionFlat
    ) {
    ...
    public static SpellStainedRunicTabletServerConfig define(ForgeConfigSpec.Builder builder) {
    ...
    private static ForgeConfigSpec.DoubleValue defineBonus(ForgeConfigSpec.Builder builder, String name, double defaultValue) {
        return builder
    ...
    private record ConfiguredRarityBonuses(
            ForgeConfigSpec.DoubleValue common,
            ForgeConfigSpec.DoubleValue uncommon,
            ForgeConfigSpec.DoubleValue rare,
            ForgeConfigSpec.DoubleValue epic,
            ForgeConfigSpec.DoubleValue legendary,
            ForgeConfigSpec.DoubleValue mythicOver
    ) {
