...
public final class HighTierSwingcastStaffServerConfig {
    ...
    private final ModConfigSpec.IntValue diamondCooldownReductionTicks;
    private final ModConfigSpec.IntValue netheriteCooldownReductionTicks;
    ...
    private HighTierSwingcastStaffServerConfig(
            ModConfigSpec.IntValue diamondCooldownReductionTicks,
            ModConfigSpec.IntValue netheriteCooldownReductionTicks
    ) {
    ...
    public static HighTierSwingcastStaffServerConfig define(ModConfigSpec.Builder builder) {
    ...
    private static int clampTicks(int ticks) {
        return Math.clamp(ticks, 0, MAX_CONFIGURED_TICKS);
    }
}
