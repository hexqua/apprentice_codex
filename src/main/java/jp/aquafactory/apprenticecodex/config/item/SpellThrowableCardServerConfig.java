...
public final class SpellThrowableCardServerConfig {
    ...
    private final ModConfigSpec.IntValue spellInvokeCardCraftCount;
    private final ModConfigSpec.IntValue spellAutonomyCardCraftCount;

    private Values override;

    private SpellThrowableCardServerConfig(
            ModConfigSpec.IntValue spellInvokeCardCraftCount,
            ModConfigSpec.IntValue spellAutonomyCardCraftCount
    ) {
        this.spellInvokeCardCraftCount = spellInvokeCardCraftCount;
        this.spellAutonomyCardCraftCount = spellAutonomyCardCraftCount;
    }

    public static SpellThrowableCardServerConfig define(ModConfigSpec.Builder builder) {
