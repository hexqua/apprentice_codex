...
public final class FloatmountBroomServerConfig {
    ...
    private final ModConfigSpec.DoubleValue overdriveHorizontalManaCostPerTick;
    private final ModConfigSpec.DoubleValue overdriveAscendingManaCostPerTick;
    private final ModConfigSpec.DoubleValue overdriveHorizontalAscendingManaCostPerTick;
    ...
    private FloatmountBroomServerConfig(
            ...
            ModConfigSpec.DoubleValue overdriveHorizontalManaCostPerTick,
            ModConfigSpec.DoubleValue overdriveAscendingManaCostPerTick,
            ModConfigSpec.DoubleValue overdriveHorizontalAscendingManaCostPerTick
    ) {
