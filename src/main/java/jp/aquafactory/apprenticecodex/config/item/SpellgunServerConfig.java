...
public final class SpellgunServerConfig {
    ...
    private static BooleanConfig defineIgnoreMaxMana(ForgeConfigSpec.Builder builder) {
    ...
    private static MalignantConfig defineMalignant(ForgeConfigSpec.Builder builder) {
    ...
    private static int configuredTicks(ForgeConfigSpec.IntValue value, int defaultValue) {
        try {
            return value.get();
    ...
    private record BooleanConfig(ForgeConfigSpec.BooleanValue configuredValue, boolean defaultValue) {
        boolean value() {
            try {
    ...
    private record MalignantConfig(
            ForgeConfigSpec.DoubleValue forcedSpellPowerValue,
            ForgeConfigSpec.DoubleValue forcedSchoolSpellPowerValue,
            ForgeConfigSpec.DoubleValue forcedSummonDamageValue
    ) {
    ...
    private static double configuredMultiplier(ForgeConfigSpec.DoubleValue value, double defaultValue) {
        try {
