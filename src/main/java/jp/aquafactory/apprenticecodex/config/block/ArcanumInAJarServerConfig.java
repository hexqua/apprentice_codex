...
public final class ArcanumInAJarServerConfig {
    ...
    private final ForgeConfigSpec.ConfigValue<String> materialItemId;
    private final ForgeConfigSpec.ConfigValue<String> productItemId;
    ...
    private ArcanumInAJarServerConfig(
            ForgeConfigSpec.IntValue ticksPerStoredParameter,
            ForgeConfigSpec.ConfigValue<String> materialItemId,
            ForgeConfigSpec.ConfigValue<String> productItemId
    ) {
