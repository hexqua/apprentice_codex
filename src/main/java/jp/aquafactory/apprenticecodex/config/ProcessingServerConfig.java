...
final class ProcessingServerConfig {
    ...
    private final ModConfigSpec.ConfigValue<List<? extends String>> heavenlyFistCreateRecipeDenylist;
    ...
    private ProcessingServerConfig(
            ...
            ModConfigSpec.ConfigValue<List<? extends String>> heavenlyFistCreateRecipeDenylist,
