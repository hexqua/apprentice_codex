...
public final class ApprenticeCodexCommonConfig {
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> SCHOOL_AFFINITY_PRIORITY;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> SCHOOL_AFFINITY_DENY;
    ...
    static {
        ...
        builder.comment(
                ...
                .push("SchoolAffinity");
        SCHOOL_AFFINITY_PRIORITY = builder.defineListAllowEmpty("schoolAffinityPriority", List.<String>of(),
                value -> value instanceof String text && !text.isBlank());
        SCHOOL_AFFINITY_DENY = builder.defineListAllowEmpty("schoolAffinityDeny", List.<String>of(),
                value -> value instanceof String text && !text.isBlank());
        builder.pop();
        SPEC = builder.build();
    }
