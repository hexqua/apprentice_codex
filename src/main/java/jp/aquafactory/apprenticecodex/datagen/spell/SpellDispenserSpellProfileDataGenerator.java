...
public final class SpellDispenserSpellProfileDataGenerator extends JsonCodecProvider<SpellDispenserSpellProfileList> {
    ...
    public static List<SpellDispenserSpellProfileDefinition> createProfileDefinitions() {
        return List.of(
                                ...
                                new SpellDispenserSpellProfileDefinition(
                                        getResourceLocationRegistry(jp.aquafactory.apprenticecodex.registry.SpellRegistry.SHIDEN),
                                        SpellDispenserSpellProfile.OWNER_OPTIONAL_UP
                                ),
                                new SpellDispenserSpellProfileDefinition(
                        ...
                        new SpellDispenserSpellProfileDefinition(
                                getResourceLocationRegistry(jp.aquafactory.apprenticecodex.registry.SpellRegistry.CATCH_FLAME),
                                SpellDispenserSpellProfile.OWNER_OPTIONAL
                        ),
                        new SpellDispenserSpellProfileDefinition(
                                ...
                                new SpellDispenserSpellProfileDefinition(
                                        getResourceLocationRegistry(jp.aquafactory.apprenticecodex.registry.SpellRegistry.HEAVENLY_FIST),
                                        SpellDispenserSpellProfile.OWNER_OPTIONAL
                                ),
                                new SpellDispenserSpellProfileDefinition(
                                        getResourceLocationRegistry(jp.aquafactory.apprenticecodex.registry.SpellRegistry.COMBUSTION_JET),
                                        SpellDispenserSpellProfile.OWNER_OPTIONAL
                                ),
                                new SpellDispenserSpellProfileDefinition(
