...
public final class BlockLootTableGenerator extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(BlockRegistry.SPELL_CALIBRATION_BENCH.get());
        ...
        dropSelf(BlockRegistry.MAGNETIC_STABILITY_ANCHOR.get());
    ...
    protected @NotNull Iterable<Block> getKnownBlocks() {
        return List.of(
                ...
                BlockRegistry.SPELL_CALIBRATION_BENCH.get(),
                ...
                BlockRegistry.MAGNETIC_STABILITY_ANCHOR.get(),
