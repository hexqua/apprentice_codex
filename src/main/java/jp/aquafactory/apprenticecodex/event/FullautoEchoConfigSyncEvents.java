...
public final class FullautoEchoConfigSyncEvents {
    private FullautoEchoConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(FullautoEchoConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(FullautoEchoConfigSyncEvents::onConfigReloading);
    }
    ...
    public static void onDatapackSync(OnDatapackSyncEvent event) {
        if (event.getPlayer() == null) syncToAllPlayers();
        else syncToPlayer(event.getPlayer());
    }
