...
import jp.aquafactory.apprenticecodex.block.apprenticestable.ApprenticesTableScreen;
...
public final class ClientSetUpEvent {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> MenuScreens.register(MenuRegistry.APPRENTICES_TABLE.get(), ApprenticesTableScreen::new));
