...
public final class FloatmountBroomConfigSyncEvents {
    ...
    private static SyncFloatmountBroomConfigPacket createPacket() {
        return new SyncFloatmountBroomConfigPacket(
                ApprenticeCodexServerConfig.floatmountBroomConfig().normalFlightManaThreshold()
        );
    }
