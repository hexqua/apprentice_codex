...
public final class ManaShieldCharmConfigSyncEvents {
    private ManaShieldCharmConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(ManaShieldCharmConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(ManaShieldCharmConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncManaShieldCharmConfigPacket createPacket() {
        return new SyncManaShieldCharmConfigPacket(
                ApprenticeCodexServerConfig.manaShieldCharmManaPerDamage(),
                ApprenticeCodexServerConfig.manaShieldCharmRecoveryThresholdMana()
        );
    }
    ...
    public static final class ClientEvents {
        ...
        public static void onClientLogout(ClientPlayerNetworkEvent.LoggingOut event) {
            ManaShieldCharmConfigState.reset();
        }
    }
}
