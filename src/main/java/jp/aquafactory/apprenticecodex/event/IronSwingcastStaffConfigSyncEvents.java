...
public final class IronSwingcastStaffConfigSyncEvents {
    private IronSwingcastStaffConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(IronSwingcastStaffConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(IronSwingcastStaffConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncIronSwingcastStaffConfigPacket createPacket() {
        return new SyncIronSwingcastStaffConfigPacket(
                ApprenticeCodexServerConfig.ironSwingcastStaffCrystallineArcaneShardDropChance()
        );
    }
    ...
    public static final class ClientEvents {
        ...
        public static void onClientLogout(ClientPlayerNetworkEvent.LoggingOut event) {
            IronSwingcastStaffConfigState.reset();
        }
    }
}
