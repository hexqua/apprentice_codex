...
@net.minecraftforge.fml.common.Mod.EventBusSubscriber(modid = ApprenticeCodex.MODID, value = net.minecraftforge.api.distmarker.Dist.CLIENT)
public final class QuickcastCartridgeHud {
    ...
    public static void onRender(net.minecraftforge.client.event.RenderGuiOverlayEvent.Post event) {
        if (event.getOverlay() == net.minecraftforge.client.gui.overlay.VanillaGuiOverlay.FOOD_LEVEL.type())
    ...
    private void render(GuiGraphics graphics, float partialTick) {
        ...
        int y = graphics.guiHeight() - ((net.minecraftforge.client.gui.overlay.ForgeGui) minecraft.gui).rightHeight;
        ...
        ((net.minecraftforge.client.gui.overlay.ForgeGui) minecraft.gui).rightHeight += 10;
    }
