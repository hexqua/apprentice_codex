...
public final class LinearBuildConfigSyncEvents {
    private LinearBuildConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(LinearBuildConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(LinearBuildConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncLinearBuildConfigPacket createPacket() {
        return new SyncLinearBuildConfigPacket(
