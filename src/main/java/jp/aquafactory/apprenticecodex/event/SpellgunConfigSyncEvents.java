...
public final class SpellgunConfigSyncEvents {
    private SpellgunConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(SpellgunConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(SpellgunConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncSpellgunConfigPacket createPacket() {
