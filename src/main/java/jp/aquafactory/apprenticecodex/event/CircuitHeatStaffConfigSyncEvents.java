...
public final class CircuitHeatStaffConfigSyncEvents {
    private CircuitHeatStaffConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(CircuitHeatStaffConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(CircuitHeatStaffConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncCircuitHeatStaffConfigPacket createPacket() {
        return new SyncCircuitHeatStaffConfigPacket(
                ApprenticeCodexServerConfig.circuitHeatStaffCooldownBypassMaxRemainingTicks()
        );
    }
    ...
    public static final class ClientEvents {
        ...
        public static void onClientLogout(ClientPlayerNetworkEvent.LoggingOut event) {
            CircuitHeatStaffConfigState.reset();
        }
    }
}
