...
public class ElementalBowRenderer extends GeoItemRenderer<ElementalBow> {
    ...
    private ElementalBowClientRenderState.OrbRenderState orbState =
            new ElementalBowClientRenderState.OrbRenderState(false, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F);
    ...
    public void doPostRenderCleanup() {
        ...
        this.orbState = new ElementalBowClientRenderState.OrbRenderState(false, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F);
        this.orbGlowPassActive = false;
        this.orbGlowPassScale = 1.0F;
    }
}
