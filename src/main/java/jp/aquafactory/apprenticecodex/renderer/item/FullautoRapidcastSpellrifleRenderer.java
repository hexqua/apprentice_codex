...
public final class FullautoRapidcastSpellrifleRenderer extends GeoItemRenderer<FullautoRapidcastSpellrifle> {
    ...
    private static final RenderType RUNE_BARREL_RENDER_TYPE =
            ApprenticeRenderTypes.entityAdditiveGlowNoCullColorOnly("fullauto_rapidcast_spellrifle_rune_barrel_additive", TEXTURE);
    ...
    private static final RenderType CHAMBER_RENDER_TYPE =
            ApprenticeRenderTypes.entityAdditiveGlowNoCullColorOnly("fullauto_rapidcast_spellrifle_chamber_additive", TEXTURE);
