...
public final class TotemOfPermafrostPulseRenderEvent {
    ...
    private static final RenderType WAVE_RENDER_TYPE =
            ApprenticeRenderTypes.entityAdditiveGlowNoCull("totem_of_permafrost_pulse_additive", WAVE_TEXTURE);
    ...
    private static final float COLOR_RED = 0.42f;
    private static final float COLOR_GREEN = 0.86f;
    private static final float COLOR_BLUE = 1.0f;
    private static final Deque<ActivePulse> ACTIVE_PULSES = new ArrayDeque<>();

    private TotemOfPermafrostPulseRenderEvent() {
    }
