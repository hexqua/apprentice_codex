...
public class TiroVolley extends AbstractSpell implements ICastHighlightSpell, IMagiAgentSuitAffectedSpell {
    ...
    private void spawnMusket(ServerLevel level, int spellLevel, LivingEntity caster, int fireDelay) {
        ...
        AudioTools.playSoundFromEntity(level, musket, SoundRegistry.VANILLA_SUMMON_WEAPON.get(), SoundSource.PLAYERS, 0.5f);
        AudioTools.playSoundFromEntity(level, musket, SoundRegistry.VANILLA_HOLD_WEAPON.get(), SoundSource.PLAYERS, 0.5f, 1.5f);
    }
