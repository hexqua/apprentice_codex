...
public final class PresetSpellContainerStateHelper {
    ...
    public static void rememberOverridden(ItemStack stack, SpellData spellData) {
        ...
        var stateTag = stack.getOrCreateTagElement(ROOT_TAG);
    ...
    public static void rememberCleared(ItemStack stack) {
        ...
        stateTag.remove(SPELL_ID_TAG);
        stateTag.remove(SPELL_LEVEL_TAG);
    }
    ...
    private static RememberedState getRememberedState(ItemStack stack) {
        var stateTag = stack.getTagElement(ROOT_TAG);
        if (stateTag == null) {
            return null;
        }
        ...
        return new RememberedState(type, new SpellData(spell, stateTag.getInt(SPELL_LEVEL_TAG)));
    }
