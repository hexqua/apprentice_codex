...
public final class ChargedTwinBladeStaffConfigSyncEvents {
    private ChargedTwinBladeStaffConfigSyncEvents() {
    }

    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(ChargedTwinBladeStaffConfigSyncEvents::onConfigLoading);
        modEventBus.addListener(ChargedTwinBladeStaffConfigSyncEvents::onConfigReloading);
    }
    ...
    private static SyncChargedTwinBladeStaffConfigPacket createPacket() {
        return new SyncChargedTwinBladeStaffConfigPacket(
