...
public final class EnchantressEnchantingTableBonusHelper {
    ...
    public static int getBonusForPlayer(@Nullable Player player) {
        if (player == null || !ApprenticeAttributeRegistry.MAX_ENCHANTMENT_TABLE_LEVEL.isBound()) {
            return 0;
        }

        var attributeId = ApprenticeAttributeRegistry.MAX_ENCHANTMENT_TABLE_LEVEL.getId();
        var bonus = 0.0D;
