 ...
 */
public final class FullautoRapidcastSpellrifleScrollStorage {
    private static final String ROOT = "FullautoRapidcastSpellrifleCalibration";
    public static final int MAX_SCROLL_SLOTS = 4;

    private FullautoRapidcastSpellrifleScrollStorage() {
    }
