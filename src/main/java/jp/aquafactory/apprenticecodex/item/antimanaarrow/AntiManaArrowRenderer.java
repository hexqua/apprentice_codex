...
public final class AntiManaArrowRenderer extends ArrowRenderer<AntiManaArrowEntity> {
    ...
    public void render(AntiManaArrowEntity entity, float yaw, float partialTicks, PoseStack poseStack,
        ...
        vertex(pose, consumer, -7, -2, -2, 0.0F, 0.15625F, -1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, -2, 2, 0.15625F, 0.15625F, -1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, 2, 2, 0.15625F, 0.3125F, -1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, 2, -2, 0.0F, 0.3125F, -1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, 2, -2, 0.0F, 0.15625F, 1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, 2, 2, 0.15625F, 0.15625F, 1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, -2, 2, 0.15625F, 0.3125F, 1, 0, 0, LightTexture.FULL_BRIGHT);
        vertex(pose, consumer, -7, -2, -2, 0.0F, 0.3125F, 1, 0, 0, LightTexture.FULL_BRIGHT);
        for (var i = 0; i < 4; ++i) {
            ...
            vertex(pose, consumer, -8, -2, 0, 0.0F, 0.0F, 0, 1, 0, LightTexture.FULL_BRIGHT);
            vertex(pose, consumer, 8, -2, 0, 0.5F, 0.0F, 0, 1, 0, LightTexture.FULL_BRIGHT);
            vertex(pose, consumer, 8, 2, 0, 0.5F, 0.15625F, 0, 1, 0, LightTexture.FULL_BRIGHT);
            vertex(pose, consumer, -8, 2, 0, 0.0F, 0.15625F, 0, 1, 0, LightTexture.FULL_BRIGHT);
        }
        poseStack.popPose();
    }
