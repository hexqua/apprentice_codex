...
public final class AntiManaArrowEntity extends AbstractArrow {
    ...
    public AntiManaArrowEntity(Level level, LivingEntity owner, ItemStack pickupItem, @Nullable ItemStack firedFromWeapon) {
        super(EntityRegistry.ANTI_MANA_ARROW.get(), owner, level, pickupItem, firedFromWeapon);
    }

    public AntiManaArrowEntity(Level level, double x, double y, double z, ItemStack pickupItem) {
        super(EntityRegistry.ANTI_MANA_ARROW.get(), x, y, z, level, pickupItem, null);
    }
