...
public record SyncFocusStaffbowLoanPacket(float remainingLoanMana) {
    ...
    public static void handle(SyncFocusStaffbowLoanPacket packet, Supplier<NetworkEvent.Context> contextSupplier) {
