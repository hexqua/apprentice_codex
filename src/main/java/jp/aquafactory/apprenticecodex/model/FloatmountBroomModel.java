...
public class FloatmountBroomModel<T extends GeoAnimatable> extends GeoModel<T> {
    ...
    public void setCustomAnimations(T animatable, long instanceId, AnimationState<T> animationState) {
        ...
        if (animatable instanceof FloatmountBroomEntity broom) {
    ...
    private void applyEntityDecoAnimation(GeoBone deco, FloatmountBroomEntity broom, long instanceId,
    ...
    private static float updateDecoSwingState(DecoSwingState state, FloatmountBroomEntity broom,
