...
public final class ArsNouveauLuminousDeviceCompat {
    ...
    public static void register() {
        ...
        try {
            ...
            // Ars Nouveau 1.20.1 の内蔵動的光源は LambDynamicLights の JSON を読まないため、ここで追加登録する。
            // 1.21.1 は同梱 LambDynamicLights API が JSON 定義を読むため、forward-port 時はこの compat を移植せず削除してよい。
