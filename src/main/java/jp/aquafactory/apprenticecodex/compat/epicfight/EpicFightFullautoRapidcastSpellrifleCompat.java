...
public final class EpicFightFullautoRapidcastSpellrifleCompat {
    ...
    public static void register(IEventBus modEventBus) {
        EpicFightEventHooks.Registry.WEAPON_CAPABILITY_PRESET.registerEvent(
                EpicFightFullautoRapidcastSpellrifleCompat::onWeaponCapabilityPresetRegistry,
    ...
    private static void onWeaponCapabilityPresetRegistry(WeaponCapabilityPresetRegistryEvent event) {
        event.getTypeEntry().put(WEAPON_TYPE_ID, EpicFightFullautoRapidcastSpellrifleCompat::buildCapability);
    }
    ...
    private static RangedWeaponCapability.Builder buildCapability(Item item) {
        return RangedWeaponCapability.builder()
                ...
                .constructor(EpicFightFullautoRapidcastSpellrifleCapability::new);
    }
}
